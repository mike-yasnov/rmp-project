...
/**
 * OpenTelemetry initialization for the api-gateway service.
 *
 ...
 *
 * Falls back to a no-op OpenTelemetry instance when the exporter cannot be reached
 * or OTEL is explicitly disabled via OTEL_SDK_DISABLED=true.
 */
object Telemetry {
    ...
    fun init(): OpenTelemetry {
        ...
        val serviceName = System.getenv("OTEL_SERVICE_NAME") ?: "api-gateway"
